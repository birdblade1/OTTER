...
std::string windowTitle = "Emmanuel Sih 100779102";
...
int main()
{
	...
	{
		//    X      Y     Z        R     G    B
			 0.5f, -0.25f, 0.5f,   1.0f, 0.2f, 0.3f, 
			 0.5f, 0.75f, 0.5f,    0.4f, 1.5f, 0.3f,
			-0.5f, 0.75f, 0.5f,    0.5f, 0.6f, 1.1f,
			-0.5f, -0.25f, 0.5f,   1.0f, 1.0f, 4.0f
	};
	...
	shader2->LoadShaderPartFromFile("shaders/fs2/frag_shader.glsl2", ShaderPartType::Fragment);
	shader2->Link();
